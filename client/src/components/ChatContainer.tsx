...
function ChatContainer() {
  ...
  console.log("Messages from container: ", messages);  // Check if messages are correctly populated

  // Display loading skeleton while messages are loading
  ...
  // Render chat messages when they are available
  return (
    <div className="flex-1 flex flex-col overflow-auto">
      <ChatHeader />
